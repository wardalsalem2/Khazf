        ...
        <div class="bg-white p-4 rounded shadow-sm" style="max-width: 900px; margin: 0 auto;">
            ...
            <form action="{{ route('admin.experiences.update', $experience->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="description" class="form-control" rows="3" required>{{ $experience->description }}</textarea>
                </div>

                <div class="mb-3">
                    <label class="form-label">Location</label>
                    <input type="text" name="location" class="form-control" value="{{ $experience->location }}" required>
                </div>

                <div class="row mb-3">
                    <div class="col-md-4">
                        <label class="form-label">Price</label>
                        <input type="number" name="price" class="form-control" value="{{ $experience->price }}" step="0.01" required>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Duration</label>
                        <input type="text" name="duration" class="form-control" value="{{ $experience->duration }}" required>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Date</label>
                        <input type="date" name="date" class="form-control" value="{{ $experience->date }}" required>
                    </div>
                </div>

                <div class="mb-3">
                    <label class="form-label">Category</label>
                    <input type="text" name="categories" class="form-control" value="{{ $experience->categories }}" required>
                </div>
