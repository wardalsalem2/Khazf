        ...
        <div id="hero-carousel" data-bs-interval="5000" class="container carousel carousel-fade"
            ...
            <div class="carousel-item">
                <div class="carousel-container">
                    ...
                    <a href="{{ route('experiences.index') }}" class="btn-get-started animate__animated animate__fadeInUp scrollto">Click here</a>
                </div>
            </div>
            <!-- Slide 3 -->
            <div class="carousel-item">
        ...
        < <div class="container">
            <div class="row gy-4">
                <div class="col-lg-6 content" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <ul>
                        <li><i class="bi bi-check2-circle"></i> <span>Handpicked experiences curated by locals.</span>
                        </li>
                        <li><i class="bi bi-check2-circle"></i> <span>Explore Jordan’s hidden gems and
                                traditions.</span></li>
                        <li><i class="bi bi-check2-circle"></i> <span>Simple booking process and secure payments.</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="tab-pane fade" id="features-tab-2">
                    <div class="row">
                        <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                            ...
                            <p>
                                Khazf provides a platform for locals to offer genuine experiences and earn sustainable
                                income.
                            </p>
                            <p class="fst-italic">
                            ...
                            <ul>
                                <li><i class="bi bi-check2-all"></i> <span>Easy setup to showcase your unique
                                        offerings.</span></li>
                                <li><i class="bi bi-check2-all"></i> <span>Support and grow with a trusted
                                        network.</span></li>
                                <li><i class="bi bi-check2-all"></i> <span>Fair and transparent commission
                                        structure.</span></li>
                                <li><i class="bi bi-check2-all"></i> <span>Tools to manage bookings and customer
                    ...
                    <div class="row">
                        <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                            ...
                            <ul>
                                ...
                                <li><i class="bi bi-check2-all"></i> <span>Multiple payment options with full
                                        security.</span></li>
                                <li><i class="bi bi-check2-all"></i> <span>Easy cancellation and refund policies.</span>
                                </li>
                            </ul>
                            <p class="fst-italic">
                ...
                <div class="tab-pane fade" id="features-tab-4">
                    <div class="row">
                        <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                            ...
                            <ul>
                                <li><i class="bi bi-check2-all"></i> <span>Verified reviews and ratings from real
                                        travelers.</span></li>
                                <li><i class="bi bi-check2-all"></i> <span>Secure data and payment protection.</span>
                                </li>
                                <li><i class="bi bi-check2-all"></i> <span>Responsive support team ready to assist
                                        you.</span></li>
                            </ul>
                        </div>
                        <div class="col-lg-6 order-1 order-lg-2 text-center">
                    ...
                    <div class="custom-accordion" id="accordion-faq">
                        <div class="accordion-item">
                            ...
                            <div id="collapse-faq-1" class="collapse show" aria-labelledby="headingOne"
                                ...
                                <div class="accordion-body">
                                    You can book a workshop directly through our website by selecting your preferred
                                    date and time.
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapse-faq-2" class="collapse" aria-labelledby="headingTwo"
                                data-parent="#accordion-faq">
                                <div class="accordion-body">
                                    Absolutely! Our tours and workshops are designed to welcome all skill levels,
                                    including complete beginners.
                                    Our expert guides will provide step-by-step instructions to ensure a rewarding
                                    experience.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapse-faq-3" class="collapse" aria-labelledby="headingThree"
                                data-parent="#accordion-faq">
                                <div class="accordion-body">
                                    Yes, we offer custom pottery services where you can choose designs, colors, and
                                    sizes.
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapse-faq-4" class="collapse" aria-labelledby="headingFour"
                                data-parent="#accordion-faq">
                                <div class="accordion-body">
                                    We follow all recommended health protocols, including sanitizing equipment and
                                    limiting group sizes to ensure a safe environment for everyone.
                                </div>
                            </div>
                        </div>
                        <!-- .accordion-item -->
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-8">
                    <form action="{{ route('contact.store') }}" method="POST">
                        ...
                        @if(session('success'))
                            <div
                                style="background-color: #ff6b00; color: white; padding: 15px; border-radius: 8px; font-weight: bold; text-align:center;">
                                {{ session('success') }}
                            </div>
                        @endif
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-md-12">
                                <textarea name="message" rows="6" class="form-control" placeholder="Message"
                                    required></textarea>
                            </div>

                            <div class="col-md-12 text-center">
                                <button type="submit" class="btn"
                                    style="background-color: #ff6b00; color: white; font-weight: bold;">
                                    Send Message
                                </button>
